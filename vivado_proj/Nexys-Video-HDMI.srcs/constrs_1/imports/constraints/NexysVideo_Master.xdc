...
set_property -dict {PACKAGE_PIN T15 IOSTANDARD LVCMOS25} [get_ports config_done]
set_property -dict {PACKAGE_PIN T16 IOSTANDARD LVCMOS25} [get_ports config_not_done]
...
## Buttons
set_property -dict { PACKAGE_PIN B22 IOSTANDARD LVCMOS33 } [get_ports { push_buttons_5bits_tri_i[0] }]; #IO_L20N_T3_16 Sch=btnc
set_property -dict { PACKAGE_PIN D22 IOSTANDARD LVCMOS33 } [get_ports { push_buttons_5bits_tri_i[1] }]; #IO_L22N_T3_16 Sch=btnd
set_property -dict { PACKAGE_PIN C22 IOSTANDARD LVCMOS33 } [get_ports { push_buttons_5bits_tri_i[2] }]; #IO_L20P_T3_16 Sch=btnl
set_property -dict { PACKAGE_PIN D14 IOSTANDARD LVCMOS33 } [get_ports { push_buttons_5bits_tri_i[3] }]; #IO_L6P_T0_16 Sch=btnr
set_property -dict { PACKAGE_PIN F15 IOSTANDARD LVCMOS33 } [get_ports { push_buttons_5bits_tri_i[4] }]; #IO_0_16 Sch=btnu
#set_property -dict { PACKAGE_PIN G4  IOSTANDARD LVCMOS15 } [get_ports { cpu_resetn }]; #IO_L12N_T1_MRCC_35 Sch=cpu_resetn

##Switches
set_property -dict {PACKAGE_PIN E22} [get_ports switch]
...
set_property PACKAGE_PIN AA6 [get_ports OV7670_PCLK]
set_property PACKAGE_PIN Y6 [get_ports {OV7670_D[7]}]
set_property PACKAGE_PIN V9 [get_ports {OV7670_D[6]}]
set_property PACKAGE_PIN Y7 [get_ports {OV7670_D[5]}]
set_property PACKAGE_PIN AB6 [get_ports {OV7670_D[4]}]
set_property PACKAGE_PIN Y8 [get_ports {OV7670_D[3]}]
set_property PACKAGE_PIN AB7 [get_ports {OV7670_D[2]}]
set_property PACKAGE_PIN Y9 [get_ports {OV7670_D[1]}]
set_property PACKAGE_PIN T6 [get_ports {OV7670_D[0]}]
...
set_property PACKAGE_PIN AA8 [get_ports OV7670_VSYNC]
set_property CLOCK_DEDICATED_ROUTE FALSE [get_nets OV7670_PCLK_IBUF]

set_property -dict {PACKAGE_PIN W7 IOSTANDARD LVCMOS33} [get_ports OV7670_SIOD]
set_property -dict {PACKAGE_PIN AB8 IOSTANDARD LVCMOS33} [get_ports OV7670_SIOC]
set_property -dict {PACKAGE_PIN V8 IOSTANDARD LVCMOS33} [get_ports OV7670_XCLK]
set_property -dict {PACKAGE_PIN R6 IOSTANDARD LVCMOS33} [get_ports OV7670_PWDN]
set_property -dict {PACKAGE_PIN W9 IOSTANDARD LVCMOS33} [get_ports OV7670_RESET]
